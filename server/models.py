...
class DepartmentModel(BaseModel):
    ...
    id: Mapped[int] = mapped_column(BigInteger().with_variant(Integer, "sqlite"), primary_key=True, index=True, autoincrement=True)
...
class InspectorKeyModel(BaseModel):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, index=True, autoincrement=True)
    key_value: Mapped[str] = mapped_column(String(100), unique=True, index=True, nullable=False)
    fio: Mapped[str] = mapped_column(String(255), nullable=False)
